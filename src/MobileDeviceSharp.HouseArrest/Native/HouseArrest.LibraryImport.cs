...
namespace MobileDeviceSharp.HouseArrest.Native
{
    internal static partial class HouseArrest
    {
        ...
        /// </returns>
        [System.Runtime.InteropServices.LibraryImportAttribute(HouseArrest.LibraryName, EntryPoint = "house_arrest_client_new")]
        public static partial HouseArrestError house_arrest_client_new(IDeviceHandle device, LockdownServiceDescriptorHandle service, out HouseArrestClientHandle client);
        ...
        /// code otherwise.
        /// </returns>
        [System.Runtime.InteropServices.LibraryImportAttribute(HouseArrest.LibraryName, EntryPoint = "house_arrest_client_start_service")]
        public static partial HouseArrestError house_arrest_client_start_service(IDeviceHandle device, out HouseArrestClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPStr)] string? label);
        ...
        [System.Runtime.InteropServices.LibraryImportAttribute(HouseArrest.LibraryName, EntryPoint = "house_arrest_client_free")]
        public static partial HouseArrestError house_arrest_client_free(System.IntPtr client);
        ...
        /// </remarks>
        [System.Runtime.InteropServices.LibraryImportAttribute(HouseArrest.LibraryName, EntryPoint = "house_arrest_send_request")]
        public static partial HouseArrestError house_arrest_send_request(HouseArrestClientHandle client, PlistHandle dict);
        ...
        /// need to call house_arrest_get_result().
        /// </remarks>
        [System.Runtime.InteropServices.LibraryImportAttribute(HouseArrest.LibraryName, EntryPoint = "house_arrest_send_command")]
        public static partial HouseArrestError house_arrest_send_command(HouseArrestClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPStr)] string command, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPStr)] string appid);
        ...
        /// or HOUSE_ARREST_E_CONN_FAILED if a connection error occurred.
        /// </returns>
        [System.Runtime.InteropServices.LibraryImportAttribute(HouseArrest.LibraryName, EntryPoint = "house_arrest_get_result")]
        public static partial HouseArrestError house_arrest_get_result(HouseArrestClientHandle client, out PlistHandle dict);
        ...
        /// </remarks>
        [System.Runtime.InteropServices.LibraryImportAttribute(HouseArrest.LibraryName, EntryPoint = "afc_client_new_from_house_arrest_client")]
        public static partial AFCError afc_client_new_from_house_arrest_client(HouseArrestClientHandle client, out AFCClientHandle afcClient);
    }
}
#endif
