...
namespace MobileDeviceSharp.PropertyList.Native
{
    internal static partial class Plist
    {
        ...
        public static extern void plist_dict_next_item(PlistHandle node, PlistDictIterHandle iter, [MarshalAsAttribute(UnmanagedType.CustomMarshaler, MarshalTypeRef =typeof(UTF8Marshaler))] out string key, out PlistHandle val);
        ...
        public static extern System.IntPtr plist_get_data_ptr(PlistHandle node, out ulong length);
