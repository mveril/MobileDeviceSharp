...
{
    [CustomMarshaller(typeof(string[]), MarshalMode.Default, typeof(IDeviceListMarshaller))]
    [ContiguousCollectionMarshaller]
    public unsafe static class IDeviceListMarshaller
    {
        ...
        {
            idevice_device_list_free((IntPtr)unmanaged);
        }
    }
}
#endif
