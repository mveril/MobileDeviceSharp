...
namespace IOSLib.AFC.Native
{
    public class AFC
    {
        ...
        /// The client to free.
        /// </param>
        [IOSLib.CompilerServices.GenerateHandle("AFCClient")]
        ...
        public static extern AFCError afc_read_directory(AFCClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPStr)] string path, [MarshalAs(UnmanagedType.CustomMarshaler,MarshalTypeRef =typeof(UTF8ArrayMarshaler))] out string[] directoryInformation);
        ...
        public static extern AFCError afc_get_file_info(AFCClientHandle client, [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.LPStr)] string path, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(AFCDictionaryMarshaler))] out IReadOnlyDictionary<string, string> fileInformation);
